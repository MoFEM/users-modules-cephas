...
using PostProcDomainEle = PostProcBrokenMeshInMoab<DomainEle>;
using PostProcIntEle = PostProcBrokenMeshInMoab<IntEle>;
...
MoFEMErrorCode ElectrostaticHomogeneous::solveSystem() {
  ...
  auto post_proc_fe = boost::make_shared<PostProcIntEle>(mField);
