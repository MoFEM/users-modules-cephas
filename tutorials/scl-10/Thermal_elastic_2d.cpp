...
auto get_ents_on_mesh_skin_1 = [&]() {
  ...
  //       new OpSetBc("TEMP", false, boundaryMarker_1));
    pipeline_mng->getOpBoundaryLhsPipeline().push_back(
        new OpBoundaryMass("TEMP", "TEMP", q_unit, boost::make_shared<Range>(get_ents_on_mesh_skin_1())));
    // pipeline_mng->getOpBoundaryLhsPipeline().push_back(new OpUnSetBc("TEMP"));
    ...
    pipeline_mng->getOpBoundaryLhsPipeline().push_back(
        new OpBoundaryMass("TEMP", "TEMP", q_unit, boost::make_shared<Range>(get_ents_on_mesh_skin_5())));
    // pipeline_mng->getOpBoundaryLhsPipeline().push_back(new OpUnSetBc("TEMP"));
   ...
   // Push operators in boundary pipeline RHS for Dirichelet
    ...
    //     new OpSetBc("TEMP", false, boundaryMarker_1));
    pipeline_mng->getOpBoundaryRhsPipeline().push_back(
        new OpBoundarySource("TEMP", bc_1, boost::make_shared<Range>(get_ents_on_mesh_skin_1())));
   ...
   // Push operators in boundary pipeline RHS for Dirichelet
    ...
    //     new OpSetBc("TEMP", false, boundaryMarker_5));
    pipeline_mng->getOpBoundaryRhsPipeline().push_back(
        new OpBoundarySource("TEMP", bc_2, boost::make_shared<Range>(get_ents_on_mesh_skin_5())));
    // pipeline_mng->getOpBoundaryRhsPipeline().push_back(new OpUnSetBc("TEMP")); 
