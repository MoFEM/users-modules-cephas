...
struct OpAssembleLhs : public OpFaceEle {
public:
  OpAssembleLhs(std::string row_field_name, std::string col_field_name)
...
struct OpAssembleRhs : public OpFaceEle {
public:
  OpAssembleRhs(std::string field_name)
