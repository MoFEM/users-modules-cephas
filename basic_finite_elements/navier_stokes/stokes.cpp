...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    CHKERR PetscOptionsBegin(PETSC_COMM_WORLD, "", "Stokes problem",
                             "none");
    ...
    CHKERR m_field.add_finite_element("STOKES_FLOW");
    CHKERR m_field.modify_finite_element_add_field_row("STOKES_FLOW", "U");
    CHKERR m_field.modify_finite_element_add_field_col("STOKES_FLOW", "U");
    CHKERR m_field.modify_finite_element_add_field_data("STOKES_FLOW", "U");

    CHKERR m_field.modify_finite_element_add_field_row("STOKES_FLOW", "P");
    CHKERR m_field.modify_finite_element_add_field_col("STOKES_FLOW", "P");
    CHKERR m_field.modify_finite_element_add_field_data("STOKES_FLOW", "P");
    CHKERR m_field.modify_finite_element_add_field_data("STOKES_FLOW",
                                                        "MESH_NODE_POSITIONS");

    // Add entities to that element
    CHKERR m_field.add_ents_to_finite_element_by_type(0, MBTET, "STOKES_FLOW");
    ...
    CHKERR DMMoFEMAddElement(dm, "STOKES_FLOW");
    ...
    CHKERR DMoFEMLoopFiniteElements(dm, "STOKES_FLOW", feLhs);
    ...
    CHKERR DMMoFEMKSPSetComputeOperators(dm, "STOKES_FLOW", feLhs, nullFE, nullFE);
    ...
    CHKERR DMoFEMLoopFiniteElements(dm, "STOKES_FLOW", &post_proc);
